  ...
  const cardContent = (
    <Dialog>
      <DialogTrigger asChild>
        <div className="card-3d h-full cursor-pointer rounded-3xl bg-card/40 border border-primary/10 hover:border-primary/30 active:border-primary/30 transition-all duration-300 overflow-hidden shadow-xl">
      ...
      <div className="container relative z-10 mx-auto max-w-7xl">
            ...
            <div className="flex overflow-x-auto no-scrollbar pb-4 gap-2 md:gap-4 md:justify-center w-full max-w-2xl">
              {categories.map((cat) => (
                <Button
                  ...
                  className={`flex-shrink-0 h-11 md:h-12 px-6 md:px-8 rounded-full text-xs md:text-base font-semibold transition-all duration-200 active:scale-[0.97] ${filter === cat
        ...
        {!showAll && filteredProjects.length > 3 && (
          <div className="mt-12 text-center">
            <Button
              ...
              className="h-12 px-10 rounded-full bg-primary/10 text-primary border border-primary/20 hover:bg-primary hover:text-white transition-all duration-200 font-semibold active:scale-[0.97]"
            >
              View All Projects
            </Button>
          </div>
        ...
        <div className="mt-16 md:mt-24 text-center">
          <Button
            variant="outline"
            size="lg"
            className="h-14 md:h-16 px-8 md:px-12 rounded-2xl text-base md:text-xl font-bold glow-border hover:bg-primary hover:text-white transition-all duration-300 active:scale-[0.97]"
